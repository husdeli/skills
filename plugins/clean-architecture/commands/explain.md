...
Load the **`clean-writing`** skill first (namespaced here as `clean-architecture:clean-writing`) and follow it for every sentence. This command adds the rules below on top of it.
