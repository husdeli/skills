...
...and read `prd.md`, `design.md`, and `roadmap.md` yourself. You need four things the interviewer will not hand you: the product's vocabulary, the surfaces this request touches, the roadmap's ID scheme and numbering, and the existing tasks the request duplicates or depends on.
...
**Design doc** — [surface] — [what changes]  (or: no change)
