...
- **Take the vocabulary from the project**, in this order: `.clean-architecture/prd.md`,
  `.clean-architecture/design.md`, `CLAUDE.md`, the ticket or roadmap, then the code. Read them before you write about a domain you have
