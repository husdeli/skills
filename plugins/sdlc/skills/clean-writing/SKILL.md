...
- **Take the vocabulary from the project**, in this order: `.sdlc/prd.md`,
  `.sdlc/designs/*.design.md` (or, on an older shape, `.sdlc/*.design.md` or a single `design.md`), `AGENTS.md`, `CLAUDE.md`, the ticket or roadmap, then the code. Read them before you write about a domain you have
