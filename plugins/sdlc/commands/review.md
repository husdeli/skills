...
- **A ticket ID or ticket path** → find the ticket by ID (glob `.sdlc/tickets/*/<ID>-*.md`, then `.sdlc/tickets/<ID>-*.md`), read it, and review the current change with the ticket's acceptance criteria as the standard.
